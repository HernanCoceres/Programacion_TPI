...
El sistema implementa un **sistema de gestión de productos** para depósitos o supermercados, modelando la relación **1→1 unidireccional** entre **Producto (A)** y **CódigoBarras (B)**. 
...
| **Video explicativo** | ✅ | Enlace con explicación y demostración |
...
### *Proyecto desarrollado para el Trabajo Final Integrador de Programación II - TUPaD - UTN e*